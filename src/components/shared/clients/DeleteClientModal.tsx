          ...
          >
            ...
            <div className="space-y-2 mb-8">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                You are about to permanently delete client <span className="text-red-400 font-mono font-bold tracking-wider">{clientCode}</span>. 
                This action is IRREVERSIBLE and will wipe all associated data including profiles and history.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-muted/30 border border-border rounded-xl">
                ...
                <p className="text-xs text-muted-foreground mb-4 font-medium italic">Type the Client Code exactly as shown above:</p>
                <input 
                  type="text" 
                  autoFocus
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  disabled={confirmText !== clientCode || isDeleting}
