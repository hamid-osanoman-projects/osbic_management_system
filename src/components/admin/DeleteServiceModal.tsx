        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            ...
            <div className="space-y-2 mb-8">
              <h3 className="text-xl font-syne font-bold text-foreground">Delete Service Blueprint</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                You are about to permanently delete <span className="text-red-400 font-bold tracking-wide">"{serviceName}"</span>. 
                This action is IRREVERSIBLE and will permanently remove this blueprint.
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-muted/30 border border-border rounded-xl">
                ...
                <p className="text-xs text-muted-foreground mb-4 font-medium italic">Type the Service Name exactly as shown above:</p>
                <input 
                  type="text" 
                  autoFocus
                  ...
                  className="w-full bg-background border border-border focus:border-red-500/50 outline-none rounded-xl px-4 py-3 text-sm font-bold text-red-500 transition-all placeholder:text-muted-foreground/30"
                />
              </div>
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button 
                  disabled={confirmText !== serviceName || isDeleting}
