      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="flex items-center gap-6">
          <div className="relative group">
            <div className="w-24 h-24 rounded-[2rem] bg-primary/5 border-2 border-primary/20 flex items-center justify-center text-primary text-3xl font-bold font-syne overflow-hidden shadow-sm">
               {profile?.avatar_url ? (
            ...
            <button className="absolute -bottom-2 -right-2 p-2 bg-white border border-slate-200 rounded-xl text-primary hover:text-foreground transition-all shadow-lg hover:scale-110">
               <Camera size={16} />
            </button>
          </div>
          <div>
            <h1 className="text-3xl font-syne font-bold text-foreground mb-1 tracking-tight">{profile?.full_name}</h1>
            <p className="text-[10px] text-primary font-bold uppercase tracking-widest bg-primary/10 border border-primary/20 px-3 py-1 rounded-lg inline-block">
        ...
        <button 
          ...
          className={cn(
            "px-6 py-3 rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all shadow-sm",
            isEditing 
