...
export default function EmployeeReports() {
  ...
  // States
  const [reportType, setReportType] = useState<'payments' | 'jobs'>('payments');
  ...
  const isLoading = reportType === 'payments' ? isLoadingPayments : isLoadingJobs;
  ...
  const exportToCSV = () => {
    ...
    if (reportType === 'payments') {
      ...
      headers = ['Transaction Date', 'Job Code', 'Client Name', 'Service', 'Payment Method', 'Reference', 'Payment Amount (OMR)', 'Job Total Fee (OMR)', 'Job Profit / Work Fee (OMR)', 'Job Status'];
      ...
      headers = ['Created Date', 'Job Code', 'Client Name', 'Service', 'Total Fee (OMR)', 'Ministry Fee (OMR)', 'Work Fee/Profit (OMR)', 'Status', 'Payment Status'];
            ...
            <thead className="sticky top-0 bg-card z-10 shadow-sm">
              <tr>
                ...
                {reportType === 'payments' ? (
                  ...
                  <>
                    <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-muted-foreground border-b border-border text-right">Fees (OMR)</th>
                      ...
                      <>
                        <td className="p-4 text-right">
                          <div className="flex flex-col items-end">
                            ...
                            <span className="text-[10px] text-muted-foreground">
                              Total: {item.total_fee?.toFixed(3) || '0.000'}
                            </span>
                          </div>
                        </td>
